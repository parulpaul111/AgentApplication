...
public class CandidateDataProfileActivity extends AppCompatActivity {
    public ImageView agenda,profile,political_background_history;
    Button submit;
    ...
    public static String[] election_names = {"Gram Panchayat Elections","Zila Panchayat Sadasya Elections",
            "Municipality Elections","Municipal Corporation Elections","Nagar Panchayat Sadasya Elections","State Assembly Elections"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.candidatedataprofile_activity);
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(CandidateDataProfileActivity.this, ProfileActivity.class);
    ...
    private void Type_of_elections(){
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(CandidateDataProfileActivity.this,R.array.TypeofElections,android.R.layout.simple_spinner_dropdown_item);
